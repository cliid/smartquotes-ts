...
test("smartquotes.string()", (t) => {
  ...
  const expectations = {
    ...
    "'''": "\u2034",
    "''": "\u2033",
    '"Better than a 6\'5" whale."':
      "\u201cBetter than a 6\u20325\u2033 whale.\u201d",
    "\"It's my '#1' choice!\" - 12\" Foam Finger from '93":
      "\u201cIt\u2019s my \u2018#1\u2019 choice!\u201d - 12\u2033 Foam Finger from \u201993",
    "\"Say 'what?'\" says a Mill's Pet Barn employee.":
      "\u201cSay \u2018what?\u2019\u201d says a Mill\u2019s Pet Barn employee.",
    '"Quote?": Description': "\u201cQuote?\u201d: Description",
    "'Quo Te?': Description": "\u2018Quo Te?\u2019: Description",
    '"De Poesjes van Kevin?": Something, something':
      "\u201cDe Poesjes van Kevin?\u201d: Something, something",
    "And then she blurted, \"I thought you said, 'I don't like '80s music'?\"":
      "And then she blurted, \u201cI thought you said, \u2018I don\u2019t like \u201980s music\u2019?\u201d",
    "Person 1's grammar is better than person 2's.":
      "Person 1\u2019s grammar is better than person 2\u2019s.",
  ...
  Object.keys(expectations).forEach((string) => {
    t.equal(
      ...
      expectations[string as keyof typeof expectations]
    );
  });
...
test("smartquotes.element()", async (t) => {
  ...
  const jsdom = await JSDOM.fromFile(__dirname + "/fixtures/basic.html");
  ...
  test("handling tags inside tags", (t) => {
    ...
    t.equal(
      three?.innerHTML,
      "<p>\u201cThis \u2018text with an inner <em>emphasis</em>\u2019 should be smart, too.</p><p>\u201cSuper smart.\u201d</p>"
    );
    t.end();
  });
...
test("smartquotes()", (t) => {
  ...
  test("detects and converts html documents", async (t) => {
    const jsdom = await JSDOM.fromFile(__dirname + "/fixtures/basic.html");
    const { document } = jsdom.window;
...
test("smartquotes in a browser", async () => {
  const jsdom = await JSDOM.fromFile(__dirname + "/fixtures/browser.html", {
  ...
  const window = document.defaultView as Window &
    typeof globalThis & { smartquotes: typeof smartquotes };
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    test("it can react to DOM mutations", (t) => {
        const listener = window.smartquotes.listen();
        ...
        changedNode.childNodes[0].nodeValue = 'Changing "this" node.';
        setTimeout(() => {
    ...
    test("it does not replace text in an ignored tag", (t) => {
        const listener = window.smartquotes.listen();
        const addedNode = window.document.createElement("code");
        const changedNode = window.document.createElement("code");
        addedNode.innerHTML = 'Adding "this" node.';
        changedNode.innerHTML = "No quotes.";
        window.document.body.appendChild(addedNode);
        t.equal(changedNode.innerHTML, "No quotes.");
        ...
        setTimeout(() => {
        t.not(addedNode.innerHTML, "Adding \u201cthis\u201d node.");
        t.not(changedNode.innerHTML, "Changing \u201cthis\u201d node.");
        listener.disconnect();
        t.end();
        });
    });
